...
class ProductController extends Controller
{
    ...
    {
        // Lấy danh sách sản phẩm mới nhất và các hình ảnh liên quan
        $products = Product::latest('id')->with('product_images');

        // Nếu có keyword, thực hiện tìm kiếm theo tiêu đề sản phẩm
            ...
            try {
                ...
                if (!empty($request->image_array)) {
                    foreach ($request->image_array as $temp_image_id) {
                        ...
                        // Lấy tên file gốc mà không thêm tiền tố nào
                        $imageName = $tempImageInfo->name;

                        // Lưu ProductImage vào CSDL
    ...
    public function edit($id, Request $request)
    {
        ...
        $productImages = ProductImage::where('product_id', $product->id)->get(); // Đổi $productImage thành $productImages
