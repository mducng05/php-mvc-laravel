        ...
        <div class="container">
            ...
            <div class="login-form">    
                <form action="{{ route('front.processResetPassword') }}" method="post">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control @error('cofirm_password') is-invalid  @enderror" placeholder="Cofirm Password" name="cofirm_password" value="">
                ...
                <div class="text-center small"><a href="{{ route('account.auth') }}">Click Here to Login</a></div>
            </div>
        </div>
    </section>
