            ...
            <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
                <div class="col-lg-4 logo">
                    <a href="{{ route('front.home') }}" class="text-decoration-none">
                        <span class="h1 text-uppercase text-primary px-2"><img src="{{asset('front-assets/images/DHD Gaming.png')}}" alt="" style="height: 1.05em; width: auto;"></span>
                        <span class="h1 text-uppercase text-darkaccount.login bg-primary px-2 ml-n1" style="font-style: italic !important;color:black;">DHD Gaming</span>
                    </a>
                </div>
