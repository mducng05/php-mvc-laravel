        ...
        <div class="row ">
                                ...
                                <div class="col-md-12 mt-5">
                                    ...
                                    @if($product->product_rating->isNotEmpty())
                                        @foreach($product->product_rating as $rating)
                                            @php
                                                // Kiểm tra rating có hợp lệ (từ 0 đến 5)
                                                $ratingValue = max(0, min(5, $rating->rating));
                                                $ratingPer = ($ratingValue * 100) / 5; // Tính tỷ lệ phần trăm
                                            @endphp
                                            <div class="rating-group mb-4">
                                                <span><strong>{{ $rating->username }}</strong></span>
                                                <div class="star-rating mt-2" title="{{ round($ratingPer) }}%">
                                                    <div class="back-stars">
                                                        <i class="fa fa-star" aria-hidden="true"></i>
                                                        <i class="fa fa-star" aria-hidden="true"></i>
                                                        <i class="fa fa-star" aria-hidden="true"></i>
            ...
            <div class="col-md-7">
                <div class="bg-light right">
                    ...
                    <h2 class="price text-secondary"><del>{{ number_format($product->compare_price, 0, '.', '.') }} VND</del></h2>
                    @endif
                    <h2 class="price">{{ number_format($product->price, 0, '.', '.') }} VND</h2>
                ...
                <div class="card product-card">
                    ...
                    <div class="card-body text-center mt-3">
                        ...
                        <div class="price mt-2">
                            ...
                            <span class="h5"><strong>{{ number_format($relProduct->price, 0, '.', '.') }} VND</strong></span>
                            @if ($relProduct->compare_price > 0)
                                <span class="h6 text-underline"><del>{{ number_format($relProduct->compare_price, 0, '.', '.') }} VND</del></span>
                            @endif
                        </div>
                    </div>                             
                </div> 
