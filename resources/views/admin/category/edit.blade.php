                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Name" placeholder="Name" value="{{$category -> name }}">	
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" readonly name="slug" id="slug" class="form-control" placeholder="Slug" value="{{ optional($category)->slug }}" />
                            </div>
                        </div>                        
                        <div class="col-md-6">
                            <div class="mb-3">
...
<script>
    ...
    $("#categoryForm").submit(function(event) {
        ...
        $.ajax({
            url: '{{ route("categories.update",$category -> id) }}', // Đường dẫn lưu dữ liệu
            type: "put",   
